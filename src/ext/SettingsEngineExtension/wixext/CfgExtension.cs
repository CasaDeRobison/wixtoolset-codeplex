//-------------------------------------------------------------------------------------------------
// <copyright file="CfgExtension.cs" company="Outercurve Foundation">
...
namespace WixToolset.Extensions
{
    ...
    /// The Windows Installer XML Toolset Cfg Extension.
    /// </summary>
    public sealed class CfgExtension : WixExtension
    {
        private CfgCompiler compilerExtension;
        private CfgDecompiler decompilerExtension;
        ...
        public override CompilerExtension CompilerExtension
        {
            get
            {
                ...
                {
                    this.compilerExtension = new CfgCompiler();
                }
        ...
        public override DecompilerExtension DecompilerExtension
        {
            get
            {
                ...
                {
                    this.decompilerExtension = new CfgDecompiler();
                }
        ...
        public override Library GetLibrary(TableDefinitionCollection tableDefinitions)
        {
            ...
            {
                this.library = LoadLibraryHelper(Assembly.GetExecutingAssembly(), "Microsoft.Tools.WindowsInstallerXml.Extensions.Data.cfg.wixlib", tableDefinitions);
            }
