...
namespace Microsoft.Tools.WindowsInstaller.Tools
{
    ...
    public class Inspector
    {
        ...
        private static readonly Dictionary<string, string> OldToNewNamespaceMapping = new Dictionary<string, string>() {
            { "http://schemas.microsoft.com/wix/2005/02/pubca", "http://wixtoolset.org/schemas/pubca" },
            { "http://wixtoolset.org/schemas/thmutil/2010", "http://wixtoolset.org/schemas/thmutil" },
            { "http://schemas.microsoft.com/wix/BalExtension", "http://wixtoolset.org/schemas/BalExtension" },
            { "http://schemas.microsoft.com/wix/ComPlusExtension", "http://wixtoolset.org/schemas/ComPlusExtension" },
            { "http://schemas.microsoft.com/wix/DependencyExtension", "http://wixtoolset.org/schemas/DependencyExtension" },
            { "http://schemas.microsoft.com/wix/DifxAppExtension", "http://wixtoolset.org/schemas/DifxAppExtension" },
            { "http://schemas.microsoft.com/wix/FirewallExtension", "http://wixtoolset.org/schemas/FirewallExtension" },
            { "http://schemas.microsoft.com/wix/GamingExtension", "http://wixtoolset.org/schemas/GamingExtension" },
            { "http://schemas.microsoft.com/wix/IIsExtension", "http://wixtoolset.org/schemas/IIsExtension" },
            { "http://schemas.microsoft.com/wix/MsmqExtension", "http://wixtoolset.org/schemas/MsmqExtension" },
            { "http://schemas.microsoft.com/wix/NetFxExtension", "http://wixtoolset.org/schemas/NetFxExtension" },
            { "http://schemas.microsoft.com/wix/PSExtension", "http://wixtoolset.org/schemas/PSExtension" },
            { "http://schemas.microsoft.com/wix/SqlExtension", "http://wixtoolset.org/schemas/SqlExtension" },
            { "http://schemas.microsoft.com/wix/TagExtension", "http://wixtoolset.org/schemas/TagExtension" },
            { "http://schemas.microsoft.com/wix/UtilExtension", "http://wixtoolset.org/schemas/UtilExtension" },
            { "http://schemas.microsoft.com/wix/VSExtension", "http://wixtoolset.org/schemas/VSExtension" },
